            ...
            ({required host, required port, required listenerOwner}) async {
              ...
              try {
                await _performGoHandshake(
                  ...
                  bootstrap: bootstrap,
                  listenerOwner: listenerOwner,
                  firstFrameOverride: const _FrameSpec(
                    kind: 10,
                    payload: <int>[],
                  ),
                );
...
RuntimeTransportBootstrap _testBootstrap() {
...
final class _FakeRuntimeTransportDelegate implements RuntimeTransportDelegate {
  _FakeRuntimeTransportDelegate({required this.onAttach});
...
final class _FrameSpec {
  const _FrameSpec({required this.kind, required this.payload});

  final int kind;
  final List<int> payload;
}

Future<void> _performGoHandshake({
  required Socket socket,
  required RuntimeTransportBootstrap bootstrap,
  required String listenerOwner,
  Future<void> Function()? beforeConfirm,
  _FrameSpec? firstFrameOverride,
  ...
  final frame =
      firstFrameOverride ?? const _FrameSpec(kind: 11, payload: <int>[]);
